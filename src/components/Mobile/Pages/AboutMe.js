    ...
    <div id={classes.aboutMePage} className={props.padding}>
      <MobileCard>
        ...
        <p>
          ...
          for my next adventure. That's how I discovered my love for coding. It
          has naturally become something I look forward to every day. I enjoy
          the feeling of accomplishment every time I get a piece of code to
          work, and the chance to apply my creative thinking skills. This led me
          to enrol in a software engineering bootcamp at General Assembly.
        </p>
        <br />
        <p>
